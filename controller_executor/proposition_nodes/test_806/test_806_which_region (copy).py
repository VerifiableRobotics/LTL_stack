...
class testing(object):
	def __init__(self):
		...
		self.pub1 = rospy.Publisher('/test_806/inputs/r550_rc', Bool, queue_size=10)	
		self.pub2 = rospy.Publisher('/test_806/inputs/r547_rc', Bool, queue_size=10)	
		self.pub3 = rospy.Publisher('/test_806/inputs/r551_rc', Bool, queue_size=10)
		self.pub4 = rospy.Publisher('/test_806/inputs/hallway_rc', Bool, queue_size=10)
